          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div key={idx} className="border border-[#d5d5d5] bg-white p-6 transition-colors hover:border-[#202020]">
                <span className="mb-3 inline-block font-serif text-[10px] font-semibold uppercase tracking-[2px] text-[#666]">
                  {job.type}
                </span>
                <h3 className="mb-2 font-serif text-[20px] font-medium text-[#202020]">{job.title}</h3>
                <p className="mb-6 font-serif text-[13px] text-[#555]">{job.location}</p>
                <button className="border-b border-[#202020] pb-1 font-serif text-[12px] font-semibold uppercase tracking-[1px] text-[#202020] transition-all hover:text-[#666] hover:border-[#666]">
                  Apply Now
                </button>
              </div>
            ))}
