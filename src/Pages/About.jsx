      ...
      <section className="w-full px-5 py-10 sm:px-8 md:px-10 md:py-10 lg:px-10">
        <div className="mx-auto grid w-full max-w-[1250px] grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-24">
          ...
          <div>
            ...
            <h2 className="max-w-[600px] font-serif text-[26px] font-medium leading-tight md:text-[40px]">
        ...
        <div className="mx-auto w-full max-w-[1250px]">
          ...
          <div className="grid w-full grid-cols-1 gap-12 md:grid-cols-3">
            <div className="border-t border-[#202020] pt-6">
              <h3 className="font-serif text-[20px] font-medium">The Beginning</h3>
              <p className="mt-4 font-serif text-[14px] leading-7 text-[#555]">
            ...
            <div className="border-t border-[#202020] pt-6">
              <h3 className="font-serif text-[20px] font-medium">Our Evolution</h3>
              <p className="mt-4 font-serif text-[14px] leading-7 text-[#555]">
            ...
            <div className="border-t border-[#202020] pt-6">
              <h3 className="font-serif text-[20px] font-medium">Looking Ahead</h3>
              <p className="mt-4 font-serif text-[14px] leading-7 text-[#555]">
      ...
      <section className="w-full border-t border-[#bdbdbd] px-5 md:px-8 lg:px-10">
        ...
        <div className="mx-auto grid w-full max-w-[1250px] grid-cols-1 lg:grid-cols-2">
          ...
          <div className="py-12 lg:border-r lg:border-[#bdbdbd] lg:py-10 lg:pr-20">
            ...
            <h2 className="max-w-[500px] font-serif text-[26px] font-medium leading-tight md:text-[40px]">
            ...
            {values.map((value) => (
              ...
              >
                <div className="mb-4 flex items-center justify-between">
                  <h3 className="font-serif text-[18px] md:text-[20px] font-medium">
                    {value.title}
                  </h3>
          ...
          <div className="grid w-full grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {team.map((member, index) => (
              <div key={index} className="flex flex-col group cursor-pointer">
                ...
                <div className="mt-5">
                  <h3 className="font-serif text-[18px] md:text-[20px] font-medium">{member.name}</h3>
                  <p className="mt-1 font-serif text-[13px] font-semibold uppercase tracking-[1px] text-[#666]">{member.role}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="w-full border-t border-[#bdbdbd] bg-[#f0f0f0] px-5 py-10 sm:px-8 md:px-10 md:py-10 lg:px-10">
        <div className="mx-auto flex w-full max-w-[1250px] flex-col gap-10 md:flex-row md:items-center md:justify-between">
          <div className="max-w-[500px]">
            ...
            <p className="mt-6 font-serif text-[15px] leading-8 text-[#555]">
          ...
          <div className="flex gap-16 md:gap-24">
            <div className="flex flex-col gap-6">
              <p className="font-serif text-[18px] font-medium">New York</p>
              <p className="font-serif text-[18px] font-medium text-[#777]">London</p>
              <p className="font-serif text-[18px] font-medium text-[#777]">Dubai</p>
            </div>
            <div className="flex flex-col gap-6">
              <p className="font-serif text-[18px] font-medium text-[#777]">Singapore</p>
              <p className="font-serif text-[18px] font-medium text-[#777]">Hyderabad</p>
              <p className="font-serif text-[18px] font-medium text-[#777]">Toronto</p>
            </div>
          </div>
        </div>
      </section>
