    ...
    <main className="w-full bg-[#fafafa] text-[#202020]">
      ...
      <section className="w-full px-5 pb-10 pt-8 sm:px-8 md:px-10 md:pb-16 md:pt-10 lg:px-10">
        <div className="mx-auto w-full max-w-[1250px] border-b border-[#bdbdbd] pb-8 md:pb-12">
          ...
          <p className="mb-6 font-serif text-[10px] font-semibold uppercase tracking-[3px] text-[#666]">
            Expertise
          </p>

          <h1 className="max-w-[1100px] font-serif text-[46px] font-medium leading-[1.02] tracking-tight sm:text-[56px] md:text-[72px] lg:text-[88px]">
          ...
          <div className="mt-10 grid w-full grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-20">
            ...
            <p className="max-w-[650px] font-serif text-[14px] leading-8 text-[#555] md:text-[16px] md:leading-8">
          ...
          {allServices.map((service, index) => (
            <div key={index} className="grid w-full grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-24">
              ...
              <div className="flex flex-col justify-between">
                <div>
                  <p className="mb-4 font-serif text-[11px] text-[#777]">
                    0{index + 1}
                  </p>
                  <h2 className="font-serif text-[26px] font-medium leading-tight md:text-[40px]">
                    {service.title}
                  </h2>
                  <p className="mt-6 max-w-[500px] font-serif text-[15px] leading-8 text-[#555]">
                    {service.description}
                  </p>
                </div>
                ...
                <Link
                  to={service.path}
                  className="mt-10 w-fit border-b border-[#202020] pb-1 font-serif text-[13px] font-semibold text-[#202020] transition-colors hover:text-[#666]"
                >
              ...
              <div className="border-l border-[#bdbdbd] pl-8 lg:pl-16">
                ...
                <ul className="flex flex-col gap-4">
                  {service.features.map((feature, i) => (
                    <li key={i} className="flex items-center gap-4 font-serif text-[16px] text-[#202020]">
      ...
      <section className="w-full border-t border-[#bdbdbd] bg-[#f0f0f0] px-5 py-10 sm:px-8 md:px-10 md:py-10 lg:px-10">
        <div className="mx-auto grid w-full max-w-[1250px] grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-24">
          ...
          <div className="flex flex-col gap-10">
            <div>
              <h3 className="font-serif text-[18px] md:text-[20px] font-medium text-[#202020]">Data-Informed, Not Data-Blinded</h3>
              <p className="mt-3 font-serif text-[15px] leading-8 text-[#555]">While we rely heavily on analytics to guide our decisions, we never lose sight of the human element. Marketing is ultimately about connecting with people, and true connection requires intuition and creativity alongside hard data.</p>
            </div>
            <div>
              <h3 className="font-serif text-[18px] md:text-[20px] font-medium text-[#202020]">Transparent Partnership</h3>
              <p className="mt-3 font-serif text-[15px] leading-8 text-[#555]">We act as an extension of your team. That means no black-box strategies, clear reporting on what's working (and what isn't), and a collaborative approach to solving your biggest growth challenges.</p>
            </div>
            <div>
              <h3 className="font-serif text-[18px] md:text-[20px] font-medium text-[#202020]">Agile Execution</h3>
              <p className="mt-3 font-serif text-[15px] leading-8 text-[#555]">Markets change, and rigid plans break. We build flexibility into our strategies, allowing us to pivot quickly, capitalize on emerging opportunities, and continually optimize performance.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full border-t border-[#bdbdbd] px-5 py-10 sm:px-8 md:px-10 md:py-10 lg:px-10">
        ...
        <div className="mx-auto flex w-full max-w-[1250px] flex-col gap-8 md:flex-row md:items-end md:justify-between">
          ...
          <div>
            ...
            <h2 className="max-w-[750px] font-serif text-[28px] font-medium leading-tight md:text-[42px]">
